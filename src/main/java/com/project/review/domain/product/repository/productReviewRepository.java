...
import com.project.review.domain.product.dto.ReviewRatingCountDto;
...
public interface productReviewRepository extends JpaRepository<Review, Long> {
    ...
    @Transactional
    @Query("SELECT new com.project.review.domain.product.dto.ReviewRatingCountDto(r.total_rating, COUNT(r)) " +
            "FROM Review r " +
